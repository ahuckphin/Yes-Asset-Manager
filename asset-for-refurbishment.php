	...
	<div class="w3-col l12 s12">
		...
		<div class="w3-card-4 w3-margin w3-white">
			...
			<div class="w3-container">
				...
				<h3><b>Browse and Checkout Assets for Refurbishment</b></h3>

			<b>	Please fill up particulars as you wish. </b>

				

				<form action="asset-for-refurbishment.php" method="post">
					...
					<input type="submit" name="checkout-refurbishment" id="checkout-refurbishment" value="Checkout selected asset(s) for refurbishment" />
					...
					if ($conn->connect_error) {
						...
						if (isset($_POST['checkout-refurbishment'])) { //checkout-refurbishment must match with name/ID from button on previous page.
							...
							foreach ($checkboxVariable as $hostname) {
								...
								$Destination = "Refurbishment";
								$TotalRemarks = "Technician name: " . $Name .  ". Remarks: " . $Remarks;
								...
								if ($conn->query($Sql) === TRUE) {
									...
									$Sql = "UPDATE `details` SET `Status` = 'Checked out for refurbishment' WHERE `details`.`Hostname` = '$hostname'";
									if ($conn->query($Sql) === TRUE) {
