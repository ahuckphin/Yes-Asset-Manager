	...
	<div class="w3-col l12	 s12">
		...
		<div class="w3-card-4 w3-margin w3-white">
			...
			<div class="w3-container">
				...
				<br />
				<br />
				<h3><b>New Restore Refurbishment Log</b></h3>
					...
					<table>
						...
						<tr>
							...
							<td>
								...
								Ubuntu
								<br />
								<input type="checkbox" name="work[]" value="Installed Ubuntu 20.04.3. ">
								<label for="work[]">Installed Ubuntu 20.04.3 </label><br>
				...
				if (empty($Hostname)) {
					...
					if ($conn->connect_error) {
						...
						if (empty($TotalWork)) {
							...
							$Sql = "INSERT INTO refurbishmentlog(Hostname,Work,Remarks) VALUES ('$Hostname','$TotalWork','$Remarks' )";
							if ($conn->query($Sql) === TRUE) {
								...
								echo "</br>";
								echo "</br>";
/* update status code commented out following transaction from RED YELLOW GREEN status to check-in/check-out based status
