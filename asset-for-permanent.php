	...
	<div class="w3-col l12 s12">
		...
		<div class="w3-card-4 w3-margin w3-white">
			...
			<div class="w3-container">
				...
				<h3><b>Browse and Checkout Assets for Permanent Loan</b></h3>

			<b>	Please fill up particulars as you wish. </b>

				

				<form action="asset-for-permanent.php" method="post">
					...
					<input type="submit" name="checkout-permanent" id="checkout-permanent" value="Checkout selected asset(s) for permanent loan" />
					...
					if ($conn->connect_error) {
						...
						if (isset($_POST['checkout-permanent'])) { //checkout-permanent must match with name/ID from button on previous page.
							...
							foreach ($checkboxVariable as $hostname) {
								...
								$Destination = "Permanent Loan";
								$TotalRemarks = "Organization Name: " . $Name .  ". Organization Representative Name: " . $Rep .  ". Organization Representative Contact Details: " . $Contact  .  ". Organization Representative Identity Card Number: " . $Card  .  ". Remarks: " . $Remarks;
								...
								if ($conn->query($Sql) === TRUE) {
									...
									$Sql = "UPDATE `details` SET `Status` = 'Checked out for permanent loan' WHERE `details`.`Hostname` = '$hostname'";
									if ($conn->query($Sql) === TRUE) {
