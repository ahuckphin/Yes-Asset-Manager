	...
	<div class="w3-col l12 s12">
		...
		<div class="w3-card-4 w3-margin w3-white">
			...
			<div class="w3-container">
				...
				<h3><b>Browse and Checkout Assets for Temporary Loan</b></h3>

			<b>	Please fill up particulars as you wish. </b>

				

				<form action="asset-for-temporary.php" method="post">
					...
					<table>
						...
						<tr>
							<td>Organization Representative Name: </td>
							<td><input type="text" name="text-rep" value=""></td>
						</tr>
						<tr>
							<td>Organization Representative Contact Details: </td>
							<td><input type="text" name="text-contact" value=""></td>
						</tr>
						<tr>
							<td>Organization Representative Identity Card Number: </td>
							<td><input type="text" name="text-card" value=""></td>
						</tr>
						<tr>
							<td>Estimated Checkin Date: </td>
							<td><input type="text" name="text-date" value=""></td>
						</tr>
						<tr>
							<td>Remarks: </td>
					...
					<input type="submit" name="checkout-temporary" id="checkout-temporary" value="Checkout selected asset(s) for temporary loan" />
					...
					if ($conn->connect_error) {
						...
						if (isset($_POST['checkout-temporary'])) { //checkout-temporary must match with name/ID from button on previous page.
							...
							foreach ($checkboxVariable as $hostname) {
								...
								$Card = $_POST['text-card'];
								$Date = $_POST['text-date'];
								$Remarks  = $_POST['text-remarks'];

								$Destination = "Temporary Loan";
								$TotalRemarks = "Organization Name: " . $Name .  ". Organization Representative Name: " . $Rep .  ". Organization Representative Contact Details: " . $Contact  .  ". Organization Representative Identity Card Number: " . $Card  . ". Estimated Checkin Date: " . $Date . ". Remarks: " . $Remarks;
								...
								if ($conn->query($Sql) === TRUE) {
									...
									$Sql = "UPDATE `details` SET `Status` = 'Checked out for temporary loan' WHERE `details`.`Hostname` = '$hostname'";
									if ($conn->query($Sql) === TRUE) {
